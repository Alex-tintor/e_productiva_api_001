...
public class ProgramasFormacionController {
     ...
     * List<ProgramaFormacionEntity> response =
     * programasFormacionService.getAllProgramasFormacion();
     * return new ResponseEntity<>(response, HttpStatus.ACCEPTED);
     * }
     * 
     * @GetMapping("/{id}")
     * public @ResponseBody ResponseEntity<?>
     * getProgramasFormacionById(@PathVariable("id") long id) {
     * Optional<ProgramaFormacionEntity> response =
     * programasFormacionService.getProgramasFormacionById(id);
     * return new ResponseEntity<>(response, HttpStatus.ACCEPTED);
     * }
     * 
     * @PutMapping("/")
     * public @ResponseBody ResponseEntity<?> updateFichas(@RequestBody
     * ProgramaFormacionEntity programasFormacionEntity) {
     * ProgramaFormacionEntity response =
     * programasFormacionService.createFicha(programasFormacionEntity);
     * return new ResponseEntity<>(response, HttpStatus.ACCEPTED);
     * }
     * 
     * @PostMapping("/{id}")
